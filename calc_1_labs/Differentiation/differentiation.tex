...
\begin{multipleChoice}
\choice{$\frac{d}{dx} f(x) + g(x) = f'(x) - g'(x)$}
\choice{$\frac{d}{dx} f(x) + g(x) = g'(x) + f'(x)$}
\choice{$\frac{d}{dx} f(x) + g(x) = f(x)\cdot g'(x) - g(x) \cdot f'(x)$}
\choice[correct]{$\frac{d}{dx} f(x) + g(x) = f'(x) + g'(x)$}
\end{multipleChoice}
\end{question}
\begin{question}
Using what you found in the previous problem, compute the following derivatives:
