...
&= \lim_{h\to 0}\dfrac{\answer{f(x+h)-f(x)}}{h}+\lim_{h\to 0}\dfrac{\answer{g(x+h)-g(x)}}{h}
\end{align*}
...
\end{question}
\begin{question}
Using what you found in the previous problem, compute the following derivatives where $j(x)=f(x)+g(x)$:
