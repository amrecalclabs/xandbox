...
\end{question}
\begin{question}
Define $f(x)=sin(x)^2$ in the following cell evaluate at $x=4pi$
\begin{hint}
...
\begin{question}
Using the solve command, find the solutions for $f(x)=x^2+3x+2$
\begin{hint}
...
If you ever get stuck trying to use a command, there is built in documentation (as well as Google). Type the command followed by "?" to get extensive documentation on how to use it with examples. Try this in the following cell.
\begin{onlineOnly}
\begin{sageCell}
