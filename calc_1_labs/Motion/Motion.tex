...
$t = \answer[id=particle,format=float,validator=particle-3<.25]{2.9} \text{s}$
\end{question}
\begin{question}
...
$v = \answer[id=maxvel,format=float,validator=maxvel-150<25]{165} \text{ft}\backslash \text{s}$

When did the rocket reach its highest point?

$t = \answer[id=highest,format=float,validator=highest-7.5<.5]{7.8} \text{s}$
...
$t = \answer[id=deploy,format=float,validator=deploy-10<.5]{10.2} \text{s}$

How fast was the rocket descending by that time?

$v = \answer[id=descent,format=float,validator=descent+70<11]{-60} \text{ft} \backslash \text{s}$

Describe how long each phase of the rocket lasted.

$\text{Take-off} \hspace{5mm} \answer[id=takeoff,format=float,validator=takeoff-2<.1]{2} \text{s}$

$\text{Coasting} \hspace{5mm} \answer[id=coast,format=float,validator=|coast-5.9|<.25]{6} \text{s}$

$\text{Free-fall} \hspace{5mm} \answer[id=fall,format=float,validator=|fall-2.6|<.3]{2.5} \text{s}$

$\text{Parachute fall} \hspace{5mm} \answer[id=para,format=float,validator=|para-1.6|<.2]{1.7} \text{s}$
\end{question}
\begin{question}
