...
$\answer{175} \text{ft}\backslash \text{s}$

When did the rocket reach its highest point?

$t = \answer[id=big,format=float,validator=this-7<1]{7.8} \text{s}$
...
$t = \answer[id=big,format=float,validator=this-10<.5]{10.2} \text{s}$

How fast was the rocket descending by that time?

$v = \answer[id=big,format=float,validator=big+70<11]{-60} \text{ft} \backslash \text{s}$

Describe how long each phase of the rocket lasted.

$\text{Take-off} \hspace{5mm} \answer{2} \text{s}$

$\text{Coasting} \hspace{5mm} \answer{6} \text{s}$

$\text{Free-fall} \hspace{5mm} \answer{2.5} \text{s}$

$\text{Parachute fall} \hspace{5mm} \answer{1.7} \text{s}$
\end{question}
\begin{question}
