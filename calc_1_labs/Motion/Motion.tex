...
\choice{The velocity of the banana in ft $\backslash$ s.}
\choice[correct]{The velocity of the banana in m $\backslash$ s.}
\choice{The acceleration of the banana in m $\backslash$ s$^2$.}
\choice{The acceleration of the banana in ft $\backslash$ s$^2$.}
\end{multipleChoice}
...
$t = \answer[id=particle,format=float,validator= (particle^2-2.8^2)/2.8^2 < .1]{} \text{s}$
\end{question}
\begin{question}
...
$v = \answer[id=maxvel,format=float,validator=(maxvel^2-170^2)/170^2 < .1]{} \text{ft}\backslash \text{s}$

When did the rocket reach its highest point?

$t = \answer[id=highest,format=float,validator=(highest^2-7.8^2)/7.8^2 < .1]{} \text{s}$
...
$t = \answer[id=deploy,format=float,validator=(deploy^2-10.5^2)/10.5^2 < .1]{} \text{s}$

How fast was the rocket descending by that time?

$v = -\answer[id=descent,format=float,validator=(descent^2-80^2)/80^2 < .1]{} \text{ft} \backslash \text{s}$

Describe how long each phase of the rocket lasted.

$\text{Take-off} \hspace{5mm} \answer[id=takeoff,format=float,validator=(takeoff^2-2^2)/2^2 < .05]{} \text{s}$

$\text{Coasting} \hspace{5mm} \answer[id=coast,format=float,validator=(coast^2-5.8^2)/5.8^2 < .05]{} \text{s}$

$\text{Free-fall} \hspace{5mm} \answer[id=fall,format=float,validator=(fall^2-2.5^2)/2.5^2 < .1]{} \text{s}$

$\text{Parachute fall} \hspace{5mm} \answer[id=para,format=float,validator=(para^2-1.5^2)/1.5^2 < .1]{} \text{s}$
\end{question}
\begin{question}
