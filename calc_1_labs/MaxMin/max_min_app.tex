...
Julia is building a tree house for her younger cousin. She'd like two opposite sides to be large screens to give a great view and airflow, without letting bugs pour in. The rest will be made of wood, with windows (which we will not account for). Unfortunately, to have the screen be sturdy enough for Julia to be comfortable, it will cost \$18 per foot, while the wood will cost only \$7 per foot. The treehouse will have a wood floor and ceiling, and will be three times as long as it is wide. Given that she wants the volume to be 1200 cubic feet, how should she design it to minimize the cost?
\begin{question}
