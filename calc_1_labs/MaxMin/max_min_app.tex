...
\subsubsection{James' Traffic Jam}
...
\begin{enumerate}
\item{When is the traffic moving slowest? At what speed is the traffic moving?}
\item{When is the traffic moving the most quickly? At what speed?}
\end{enumerate}
...
\end{dialogue}
\subsubsection{Julia's Tree House}
...
\begin{enumerate}
\item{Determine the dimensions and cost of the cheapest tree house.}
\end{enumerate}
...
\subsubsection{Dylan's Lemonade Stand}
...
\begin{enumerate}
\item{How should she price the lemonade to maximize her profit?}
\end{enumerate}
\begin{dialogue}
...
\end{dialogue}
\subsubsection{Handmade Paper Cups}
...
\begin{enumerate}
\item{How many cups should the company produce every day in order to minimize costs?}
\end{enumerate}
