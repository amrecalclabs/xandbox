...
\end{dialogue}
\begin{question}
%\item {What pattern do you notice in James' table? Generalize this pattern in terms of $x^n$}
%\begin{freeResponse}
This is the model solution $\answer{7}$ %You don’t actually need anything in between the begin and end line.
%\end{freeResponse}
\end{question}
