...
\end{image}
\begin{enumerate}
\item{\begin{question} Find the slope between $x = 2$ and $x = 7$. Does this seem to be a good approximation for the rate of change at $x = 2$? Why or why not? $\answer{9}$ \end{question}}
\item{\begin{question}Dylan thinks we can solve the problem by just picking something closer than 10. What is the slope between $x = 2$ and $x = 3$? $\answer{5}$ \end{question} Is this a good approximation? Is it better than the last attempt?}
\begin{dialogue}
