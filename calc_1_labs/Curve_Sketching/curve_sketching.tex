...
Take the derivative and then solve for 0. Create a number line, and mark these points. Between them, mark the sign of the derivative of any point on that interval (Do this by hand). An example is shown below.
...
Now determine the second derivative, $f''(x)$. Points where the second derivative is zero are known as \textbf{inflection points}. What happens at these points?
