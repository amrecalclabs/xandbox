...
\choice[correct]{The concavity will change in that point, but it is impossible to tell how without knowing the value of the second derivative around that point.}
\end{selectAll}
\vspace{5mm}
