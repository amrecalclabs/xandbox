...
\begin{selectAll}
\choice{I have no answer as of yet}
\choice[correct]{This graph sucks}
\end{selectAll}
...
\choice{Vertical asymptotes occur where both the numerator and denominator approach zero, and removable discontinuities occur where only the denominator approaches zero.}
\choice{Vertical asymptotes occur where only the numerator approaches zero, and removable discontinuities occur where only the denominator approaches zero.}
\end{multipleChoice}
\end{question}
