...
\graph{}
\]
Using the following sage cell solve the function for y
\end{question}
\begin{question}
...
\end{question}
\begin{question}
Now, in the following sage cell, solve the function for y, and graph the resulting equation(s). What do you notice? For help using sage refer to the \href{http://doc.sagemath.org/html/en/tutorial/tour_algebra.html#solving-equations}{documentation} here.
