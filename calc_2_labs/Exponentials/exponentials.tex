...
\begin{multipleChoice}
\choice{$2\cdot x \lim_{h \to 0} \dfrac{2^h-1}{h}$}
\choice{$2 \cdot x \lim_{h \to 0} \dfrac{2^h-2}{h}$}
\choice{$2^x \cdot \lim_{h \to 0} \dfrac{2^h-2}{h}$}
\choice[correct]{$2^x \lim_{h \to 0} \dfrac{2^h-1}{h}$}
\end{multipleChoice}
...
\begin{multipleChoice}
\choice{$a^x$}
\choice{$\ln\left(h\right) \cdot \lim_{h \to 0} \dfrac{a^x-1}{h}$}
\choice{$\ln\left(a\right) \cdot \lim_{h \to 0} \dfrac{a^h-1}{h}$}
\choice[correct]{$a^x \cdot \lim_{h \to 0} \dfrac{a^h-1}{h}$}
\end{multipleChoice}
