...
\begin{multipleChoice}
\choice{$v_{x0} = 30 \text{m} \backslash \text{s}$

$v_{y0} = 51.96 \text{m} \backslash \text{s}$}
\choice{$v_{x0} = 60 \text{m} \backslash \text{s}$

$v_{y0} = 60 \text{m} \backslash \text{s}$}
\choice[correct]{$v_{x0} = 51.96 \text{m} \backslash \text{s}$

$v_{y0} = 30 \text{m} \backslash \text{s}$}
\choice{$v_{x0} = 42.42 \text{m} \backslash \text{s}$

$v_{y0} = 42.42 \text{m} \backslash \text{s}$}
\end{multipleChoice}
